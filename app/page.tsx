  ...
  return <>
    <section className="hero">
      <div className="card hero-main">
        ...
        <p className="lead">从一份目标岗位 JD 出发，确认你已有的能力，找到真正的缺口，再用 7/14 天微项目把缺口变成简历、作品集和面试能讲的成果。</p>
    ...
    <div className="section-head"><h2>JobProof 解决三个关键问题</h2><p>聚焦产品与运营实习</p></div>
    <section className="feature-grid">
      ...
      <div className="card feature"><div className="feature-mark">✓</div><h3>下一步具体做什么？</h3><p>把抽象的“提升能力”变成 7/14 天可完成、可验收的任务包。</p></div>
    </section>
  </>;
}
