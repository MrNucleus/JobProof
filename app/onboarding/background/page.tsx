    ...
    <>
      ...
      <form className="card panel onboarding-single" onSubmit={submit}>
        ...
        <div className="form-grid">
          ...
          <div className="field"><label>目标城市</label><input value={profile.cities} onChange={e => setProfile({ ...profile, cities: e.target.value })} placeholder="例如：上海、杭州" aria-describedby="cities-hint" required /><small id="cities-hint" className="field-hint">可填写多个城市，用顿号分隔。</small></div>
