...
export default function ExpressionsPage() {
  ...
  if (!evidence.length) return <section className="card empty-state expressions-empty"><h1>还没有可用证据</h1><p>先完成一项微项目任务并提交成果，再生成求职表达。</p><Link className="btn btn-primary" href="/evidence">去提交第一份证据 →</Link></section>;
